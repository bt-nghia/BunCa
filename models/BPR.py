...
class BPR(nn.Module):
    ...
    def propagate(self, test=False):
        ...
        users_feature = [torch.zeros((self.num_users, self.embedding_size)).to(self.device), self.users_feature]
        bundles_feature = [torch.zeros((self.num_bundles, self.embedding_size)).to(self.device), self.bundles_feature]
